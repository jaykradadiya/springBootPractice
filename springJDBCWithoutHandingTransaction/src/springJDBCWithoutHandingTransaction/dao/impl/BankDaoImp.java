...
public class BankDaoImp implements BankDao {
	...
	@Override
	public void withdrow(Account fromAccount, Account toAccount, double amount) throws InsuffiecientAccountBalanceException {
		...
		if(update>0) {
			System.out.println("Amount Rs: " + amount+" is transferred from account No: "+ fromAccount.getAccountNumber() + " to account NO: "+ toAccount.getAccountNumber());
		}
